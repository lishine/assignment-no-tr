...
import { CreatePolygon, CreatePolygonSchema, Polygon } from './polygonModel'
    ...
    async createPolygon(data: CreatePolygon): Promise<ServiceResponse<Polygon>> {
        try {
            ...
            if (error instanceof Error && error.name === 'ZodError') {
                return ServiceResponse.failure<Polygon>(error.message, {} as Polygon, StatusCodes.BAD_REQUEST)
            }
